  ...
  const features = [
    {
      ...
      description: "Automate Facebook page posts, manage comments, and maintain consistent brand presence across your business page.",
      icon: "📄"
    },
    {
      title: "Community Building",
      description: "Engage with your audience through automated responses, community management, and targeted content.",
      icon: "👥"
    },
    {
      title: "Event Promotion",
      description: "Create and promote Facebook events, manage RSVPs, and boost attendance with automated campaigns.",
      icon: "📅"
    },
    {
      title: "Ad Campaign Management",
      description: "Optimize Facebook ad campaigns with AI-powered targeting and creative optimization.",
      icon: "🎯"
    }
  ];

  const stats = [
    { label: "Monthly Active Users", value: "2.9B+" },
    { label: "Business Pages", value: "200M+" },
    { label: "Daily Posts", value: "4B+" },
    { label: "Ad Revenue", value: "$84B+" }
  ];
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-full opacity-20">
          <div className="absolute top-20 right-20 w-64 h-64 bg-orange-600 rounded-full blur-3xl"></div>
          <div className="absolute top-40 right-40 w-32 h-32 bg-orange-500 rounded-full blur-2xl"></div>
          <div className="absolute top-60 right-60 w-48 h-48 bg-orange-700 rounded-full blur-3xl"></div>
        </div>
      ...
      <header className="relative z-50 px-4 sm:px-6 py-3 sm:py-4">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            ...
            <Link href="#facebook" className="text-orange-400 border-b-2 border-orange-400 pb-1 text-sm xl:text-base">Facebook</Link>
                ...
                <div className="px-4 sm:px-6 pb-6 space-y-6">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
                    <div className="text-center">
                      <h3 className="text-white text-xl font-bold mb-3">Facebook AI Powered</h3>
                      <div className="flex justify-center mb-2">
                        <div className="flex space-x-1">
                          <span className="text-yellow-300 text-lg">★★★★★</span>
                        </div>
                      </div>
                      <p className="text-orange-100 text-sm">2.9B+ Monthly Users</p>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <p className="text-white text-sm leading-relaxed text-center">
                      Build and engage your Facebook community with AI-powered content creation, 
                      automated page management, and intelligent community building strategies.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <main className="relative z-10">
        ...
        <section className="px-4 sm:px-6 py-12 sm:py-16 md:py-20 text-center">
          <div className="max-w-4xl mx-auto">
            {/* Facebook Badge */}
            <div className="inline-flex items-center space-x-3 bg-orange-900/50 backdrop-blur-sm rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8 border border-orange-800">
              <div className="text-xl sm:text-2xl text-white">👥</div>
              <span className="text-white text-xs sm:text-sm font-medium">Facebook Automation</span>
            </div>
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4">
              Build and engage your Facebook community with AI-powered content creation, automated posting, 
              and intelligent community management strategies.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to build a thriving Facebook community and grow your business presence.
              </p>
            </div>
            ...
            <div className="bg-gray-900/30 backdrop-blur-sm rounded-2xl p-12 border border-gray-800 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                  Connect your Facebook account and start building meaningful relationships with your audience 
                  through automated content and community management.
                </p>
                <button
                  onClick={() => setShowConnectForm(true)}
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-gray-900 rounded-2xl p-8 max-w-md w-full border border-gray-800 relative">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Connect with Facebook</h2>
              <p className="text-gray-400">Authorize Postiva to access your Facebook account</p>
            </div>

            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3 p-3 bg-gray-800 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">Read your profile and pages</span>
              </div>
              <div className="flex items-center space-x-3 p-3 bg-gray-800 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">Post content on your pages</span>
              </div>
              <div className="flex items-center space-x-3 p-3 bg-gray-800 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">Manage comments and messages</span>
              </div>
            </div>
      ...
      <footer className="relative z-10 px-6 py-16 border-t border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            {/* Connect With Us */}
            <div>
              <h3 className="text-orange-500 font-bold text-lg mb-4">Connect With Us</h3>
