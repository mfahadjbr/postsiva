...
export default function TikTokPage() {
  ...
  const features = [
    {
      ...
      description: "Generate trending TikTok videos with AI-powered scripts, music suggestions, and viral content ideas.",
      icon: "🎵"
    },
    {
      title: "Trend Analysis",
      description: "Stay ahead of TikTok trends with real-time trend analysis and content optimization suggestions.",
      icon: "📈"
    },
    {
      title: "Hashtag Strategy",
      description: "Discover trending hashtags and optimize your content for maximum visibility and engagement.",
      icon: "#️⃣"
    },
    {
      title: "Creator Collaboration",
      description: "Connect with TikTok creators and manage influencer partnerships for authentic brand promotion.",
      icon: "🤝"
    }
  ];
  ...
  const stats = [
    ...
    { label: "Videos Watched Daily", value: "167M+" },
    { label: "Average Session Time", value: "52 min" },
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Glowing abstract lines - gray on right */}
        <div className="absolute top-0 right-0 w-96 h-full opacity-20">
          <div className="absolute top-20 right-20 w-64 h-64 bg-orange-800 rounded-full blur-3xl"></div>
          <div className="absolute top-40 right-40 w-32 h-32 bg-orange-700 rounded-full blur-2xl"></div>
          <div className="absolute top-60 right-60 w-48 h-48 bg-orange-900 rounded-full blur-3xl"></div>
        </div>
      ...
      <header className="relative z-10 px-6 py-4">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#tiktok" className="text-orange-400 border-b-2 border-orange-400 pb-1">TikTok</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-sm border-t border-gray-800">
            <div className="px-6 py-4 space-y-4">
              ...
              <Link href="#tiktok" className="block text-orange-400">TikTok</Link>
        ...
        <section className="px-6 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center space-x-3 bg-orange-900/50 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-orange-800">
              ...
              <span className="text-white text-sm font-medium">TikTok Automation</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Create viral TikTok content, stay ahead of trends, and grow your following with AI-powered 
              video creation and trend analysis tools.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                onClick={() => setShowConnectForm(true)}
                className="bg-orange-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-orange-600 hover:shadow-xl hover:shadow-orange-500/25 transition-all duration-300 pulse-glow border border-orange-600"
              >
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to create viral content and dominate TikTok with trending videos.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-orange-500 transition-all duration-300 group">
            ...
            <div className="bg-gray-900/30 backdrop-blur-sm rounded-2xl p-12 border border-gray-800 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                  Connect your TikTok account and start creating viral content that captures attention 
                  and grows your following organically.
                </p>
                <button
                  onClick={() => setShowConnectForm(true)}
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-gray-900 rounded-2xl p-8 max-w-md w-full border border-gray-800 relative">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Connect with TikTok</h2>
              <p className="text-gray-400">Authorize Postiva to access your TikTok account</p>
            </div>

            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3 p-3 bg-gray-800 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">Read your profile and videos</span>
              </div>
              <div className="flex items-center space-x-3 p-3 bg-gray-800 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">Post videos and content</span>
              </div>
              <div className="flex items-center space-x-3 p-3 bg-gray-800 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-gray-300 text-sm">Manage comments and interactions</span>
              </div>
            </div>
